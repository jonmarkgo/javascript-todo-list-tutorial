...
const app: string = fs.readFileSync(path.resolve(__dirname, './todo-app.js'), 'utf8');
const elmish: string = fs.readFileSync(path.resolve(__dirname, './elmish.js'), 'utf8');
const init: string = fs.readFileSync(path.resolve(__dirname, './init.js'), 'utf8');
