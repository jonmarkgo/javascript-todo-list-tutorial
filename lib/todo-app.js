...
if (typeof window === 'undefined' && typeof require !== 'undefined') {
    var _a = require('./elmish.js'), a = _a.a, button = _a.button, div = _a.div, empty = _a.empty, footer = _a.footer, input = _a.input, h1 = _a.h1, header = _a.header, mount = _a.mount, section = _a.section, li = _a.li, label = _a.label, text = _a.text, ul = _a.ul, span = _a.span, strong = _a.strong;
}
// Remove conflicting imports
// import type { Action, SignalFunction } from './todo-app.d';
exports.initial_model = {
    todos: [],
    hash: "#/",
    input: ""
};
...
function update(action, model, data) {
    ...
    switch (action.type) {
        case 'ADD':
            var last = (model.todos.length > 0) ? model.todos[model.todos.length - 1] : null;
            var id = last ? last.id + 1 : 1;
            var input_1 = document.getElementById('new-todo');
            new_model.todos = new_model.todos || [];
            new_model.todos.push({
                id: id,
                title: action.text || input_1.value.trim(),
                done: false
            });
            break;
        case 'TOGGLE':
        ...
        case 'SAVE':
            ...
            var editId = parseInt(edit.id, 10);
            // End Editing
