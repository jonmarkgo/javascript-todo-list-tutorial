 ...
 */
function render_item (item: Todo, model: Model, signal: Function): Object {
  return (
    li([
      "data-id=" + item.id,
      "id=" + item.id,
 ...
 */
function render_main (model: Model, signal: Function): Object {
 ...
 */
function render_footer (model: Model, signal: Function): Object {
 ...
 * var DOM = view(model);
 */
function view (model: Model, signal: Function): Object {
