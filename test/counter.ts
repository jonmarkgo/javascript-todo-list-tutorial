...
// Use the existing Action type from lib/types.d.ts
// type Action = typeof Inc | typeof Dec | typeof Res;

// Use the existing Model type from lib/types.d.ts
// type Model = number;
...
function mount(model: number, update: (action: Action, model: number) => number, view: (model: number, signal: Signal) => HTMLElement, root_element_id: string): void {
