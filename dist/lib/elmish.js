 ...
 */
export function mount(initial_model, update, view, root_element_id, subscriptions) {
    ...
    function getStoredModel() {
        ...
        let model = JSON.parse(JSON.stringify(initial_model)); // Deep clone initial_model
        if (storedModel) {
            try {
